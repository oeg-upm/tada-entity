...
if __name__ == "__main__":
    if len(sys.argv) >= 3:
        results_fname_original = "st19-r3-results.csv"
        results_fname_title = "st19-r3-results-title.csv"
        ...
        start = datetime.now()
        o = ST19R3(results_fname, title_case=title_case)
