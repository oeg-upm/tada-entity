...
class AnnotatorTest(TestCase):
    ...
    def test_coverage(self):
        ...
        # Lc
        # print("class X Lc: ")
        # print(annotator.tgraph.nodes["classX"].Lc)
        ...
        # fc
        self.assertAlmostEqual(annotator.tgraph.nodes["Thing"].Lc, 1.5)
    ...
    def test_specificity(self):
        ...
        annotator.classes_counts["Thing"] = annotator.classes_counts["classX"] + annotator.classes_counts["classA1"] + annotator.classes_counts["classB1"]
