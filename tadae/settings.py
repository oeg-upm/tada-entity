"""
Django settings for tadae project.
...
SECRET_KEY = 'ej+4z3kg$8%1dv!cl)u48%1966_z^%+xku=k4pppcbv$v=bw7w'
...
ROOT_URLCONF = 'tadae.urls'

TEMPLATES = [
    {
        'BACKEND': 'django.template.backends.django.DjangoTemplates',
        'DIRS': [os.path.join(BASE_DIR, 'tadae', 'templates')],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
WSGI_APPLICATION = 'tadae.wsgi.application'
