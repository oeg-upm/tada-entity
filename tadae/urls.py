...
from tadae import views

urlpatterns = [
    url(r'^admin/', admin.site.urls),
    url(r'ent_ann_list', views.ent_ann_list, name="ent_ann_list"),
    url(r'ent_ann_stored_results', views.ent_ann_stored_results, name="ent_ann_stored_results"),
